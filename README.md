...
- 策略在完整样本中跑赢 `SPY` 和等权股票池。
- 样本外表现明显弱于样本内，这是过拟合风险信号，不能忽略。
- 2022 年策略表现为负，说明策略不是每年都有效。
- 成本提高到 3 倍后策略仍为正，但收益和夏普下降。
- 动量窗口 20、40、60 天都有较好结果，10 天窗口明显较弱。
- 持仓贡献靠前的股票包括 `NFLX`、`NVDA`、`LLY`、`META`、`AAPL`，收益仍有集中风险。
